...
def h160_to_p2pkh_address(h160, testnet):
    '''Takes a byte sequence hash160 and returns a p2pkh address string'''
    # p2pkh has a prefix of b'\x00' for mainnet, b'\x6f' for testnet
    prefix = b'\x6f' if testnet else b'\x00'
    return encode_base58_checksum(prefix + h160)

def h160_to_p2sh_address(h160, testnet):
    '''Takes a byte sequence hash160 and returns a p2sh address string'''
    # p2sh has a prefix of b'\x05' for mainnet, b'\xc0' for testnet
    prefix = b'\xc0' if testnet else b'\x05'
    return encode_base58_checksum(prefix + h160)
...
def flip_endian(h):
    '''Takes hex string and flips the endianness'''
    b = unhexlify(h)
    b_rev = b[::-1]
